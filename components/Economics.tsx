    ...
    >
      <div className={styles.inner}>
        ...
        <p className={styles.para}>
          ...
          дизайнерская отделка PRIDEX уже выполнена. Ремонт помещения
          в бетоне занял бы от трёх до шести месяцев и добавил бы к ставке
          около 39%.
        </p>
        ...
        <p className={styles.note}>
          Коммунальные услуги оплачиваются отдельно, по счётчикам.
        </p>
      </div>
    </section>
  );
