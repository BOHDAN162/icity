...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    a: 'Эксплуатационные расходы и НДС включены в ставку. Отдельно оплачиваются только коммунальные услуги.',
  },
  {
    id: '02',
  ...
  },
  {
    ...
    a: 'Одиннадцать месяцев. Более короткий срок обсуждается индивидуально.',
  },
  {
    id: '04',
  ...
  },
  {
    ...
    a: 'Нет. Дизайнерская отделка PRIDEX полностью выполнена — помещение готово. Мебель в ставку не входит; для неё есть готовый дизайн-проект.',
  },
  {
    id: '06',
    q: 'Можно ли переставить или убрать перегородки?',
    a: 'Да, по согласованию с собственником.',
  },
  {
    id: '07',
  ...
  },
  {
    ...
    a: 'Аренда прямая, от собственника.',
  },
];
    ...
    <section className={styles.section} id="faq" aria-labelledby="faq-eyebrow">
      <div className={styles.inner}>
        ...
        <p className={styles.note}>
          Не нашли свой — оставьте заявку и управляющий объектом ответит на все ваши вопросы.
        </p>
      </div>
