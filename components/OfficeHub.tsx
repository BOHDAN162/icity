...
/* ПОРОГИ ХОДА ВПЕРЁД — ИХ ДВА, И ОНИ РАЗНЫЕ НАРОЧНО.
   ...
   и только потом зовёт дальше. Числа за день прошли 3 → 4 → нынешние.
     ...
     READY_ZONES     3 — индикатор «Листайте вниз» в зонах: приходит
                         на просмотре третьей и дальше.
     PLAN_READY_ZONES 3 — «Дальше» в шапке плана.

   Сейчас числа совпали, и константы всё равно две: смысл у них разный,
   и заказчик за один день менял их порознь (3 → 4 → 2/3 → 3/3).
