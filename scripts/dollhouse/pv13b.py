"""
geometry v13, вторая половина (пересборка стен после pv13a.py): западный угол вернулся из v8, но БЕЗ
...
SRC, DST = 'geom_v13_data.json', 'geometry.json'
PANE     = 2.00
GAP      = 0.08
SLOT     = 0.14
SIMP     = 0.004
...
G['notes'] = ('v13: сняты глухие стены #14 (юг переговорной) и #16 (юг кабинета у колонны) — за обеими вплотную стояли стеклянные панели glazing_interior, невидимые за стеной. Остальное без изменений от v10.')
