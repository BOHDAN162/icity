...
SRC, DST = 'geom_v16_data.json', 'geometry.json'
PANE     = 2.00
GAP      = 0.08
SLOT     = 0.14
SIMP     = 0.004
...
G['notes'] = ('v16: стыки стен заподлицо (4 синих: СЗ угол гардероба, кухня/коридор, лаунж); коробки-заливки v8 заменены сегментом стены санузла и продлённой диагональю у СВ колонны (3 розовых).')
