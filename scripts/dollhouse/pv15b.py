...
SRC, DST = 'geom_v15_data.json', 'geometry.json'
PANE     = 2.00
GAP      = 0.08
SLOT     = 0.14
SIMP     = 0.004
...
PINK = [box(0.89, 2.78, 1.32, 3.06),      # у западного входа: граница y≈2,80, внутрь +y
...
G['notes'] = ('v15: по разметке — стекло кабинета продлено до колонны; стены x4,04/y5,35-6,20 и x4,02/y8,03-9,02 сняты (на месте первой добавлено стекло); сняты стык Skype и микровыступ x9,43; два тонких торца (у западного входа и у северного прохода) доведены до полной толщины; дубликаты walls_ortho вычищены.')
