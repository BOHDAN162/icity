/* iCITY 113Н — заглушки для секции «Комплекс iCITY».
   ...
   ЗАЧЕМ ЭТО СКРИПТ. Пять кадров комплекса — ландшафтный парк, лобби,
   торговая галерея, лифты и паркинг — ещё не сняты. Секция
...
const AMENITIES = [
  { key: 'park', name: 'ЛАНДШАФТНЫЙ ПАРК' },
  { key: 'lobby', name: 'ЛОББИ' },
  { key: 'gallery', name: 'ТОРГОВАЯ ГАЛЕРЕЯ' },
  { key: 'elevators', name: 'ЛИФТЫ' },
